...
function orderDetailHtml(id){
 ...
 return `<div class="order-detail-head"><div><h2>Order ${id}</h2><p><strong>${o.customer}</strong> · ${o.status} · Payment ${o.payment}</p></div><div class="order-detail-actions"><button class="secondary" onclick="window.print()">Print / Save PDF</button></div></div>
